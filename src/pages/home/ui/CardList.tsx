...
export const StartedRoomsCardList = () => {
  ...
  return <RoomCardList cardList={data?.data} isError={isError} isLoading={isLoading} started={true} />;
};

export const CreatedRoomsCardList = () => {
  const { data, isLoading, isError } = useGetCreatedDebateQuery();
  return <RoomCardList cardList={data?.data} isError={isError} isLoading={isLoading} started={false} />;
};